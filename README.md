...
Teamflow is free to use under [AGPL-3.0](LICENSE). Optional donation links (PayPal, Ko-fi) appear in the in-app **About** dialog when enabled in [`packages/core/src/about.ts`](packages/core/src/about.ts).
